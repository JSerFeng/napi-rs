...
test('should validate promise', (t) => __awaiter(void 0, void 0, void 0, function* () {
    t.is(yield validatePromise(Promise.resolve(1)), 2);
    // @ts-expect-error
    yield t.throwsAsync(() => validatePromise(1), {
        code: 'InvalidArg',
...
test('should return Promise.reject() if arg is not Promise', (t) => __awaiter(void 0, void 0, void 0, function* () {
    t.is(yield returnUndefinedIfInvalidPromise(Promise.resolve(true)), false);
    // @ts-expect-error
    yield t.throwsAsync(() => returnUndefinedIfInvalidPromise(1));
}));

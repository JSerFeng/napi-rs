...
test('should create bigints', (t) => {
    if (napiVersion >= 6) {
        ...
        t.is(bindings.testCreateBigintFromI128(), BigInt('170141183460469231731687303715884105727'));
        t.is(bindings.testCreateBigintFromU128(), BigInt('340282366920938463463374607431768211455'));
        t.is(bindings.testCreateBigintFromWords(), BigInt('-340282366920938463463374607431768211455'));
    }
    else {
...
//# sourceMappingURL=bigint.spec.js.map
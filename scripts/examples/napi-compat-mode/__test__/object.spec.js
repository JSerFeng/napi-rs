...
test('testDefineProperties', (t) => {
    ...
    t.is((_a = descriptor === null || descriptor === void 0 ? void 0 : descriptor.value) !== null && _a !== void 0 ? _a : (_b = descriptor === null || descriptor === void 0 ? void 0 : descriptor.get) === null || _b === void 0 ? void 0 : _b.call(descriptor), 'readonly');
});
test('is promise', (t) => {
    ...
    t.true(bindings.testIsPromise(new Promise((resolve) => {
        resolve();
    })));
});
